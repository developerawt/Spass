package offery.wizzo.in.offery.custom;
...
/**
 * Created by arpitjoshi on 18/7/16.
 */
...
//            mPinnedHeaderView.layout(0, mPinnedHeaderView.getMeasuredHeight(), mPinnedHeaderView.getMeasuredWidth(), mPinnedHeaderView.getMeasuredHeight());
